    ...
    <footer className="w-full border-t border-neutral-200 border-1 py-8 overflow-x-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-6">
          ...
          <Link 
            href="/" 
            className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer justify-center sm:justify-start"
            onClick={() => {
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              ...
              <Button asChild variant="ghost" size="sm">
                <Link 
                  href="/delete-account"
                  onClick={() => {
                    const eventData = { link: "delete_account" };
                    posthog.capture("footer_link_clicked", eventData);
                    trackGAEvent("footer_link_clicked", eventData);
                  }}
                >
